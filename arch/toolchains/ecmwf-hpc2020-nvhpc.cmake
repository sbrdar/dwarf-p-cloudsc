...
# existing value)
set( OpenMP_C_FLAGS         "-mp=bind,allcores,numa" CACHE STRING "" )
...
set( OpenACC_Fortran_FLAGS "-acc -gpu=deepcopy,fastmath" CACHE STRING "" )
...
set(ECBUILD_Fortran_FLAGS "${ECBUILD_Fortran_FLAGS} -cuda")
