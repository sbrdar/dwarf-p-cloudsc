...
!$omp end parallel do 
  ...
  SUBROUTINE CLOUDSC_GLOBAL_ATLAS_STATE_LOAD(SELF, NPROMA, NGPTOT, NGPTOTG)
    ...
    CALL FIELD_INIT_ATLAS(SELF%PRAINFRAC_TOPRFZ, NPROMA, SELF%NBLOCKS)
  ...
  SUBROUTINE CLOUDSC_GLOBAL_ATLAS_STATE_VALIDATE(SELF, NPROMA, NGPTOT, NGPTOTG)
    ...
    CALL VALIDATEVAR_ATLAS(FSET, 'PCOVPTOT', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PRAINFRAC_TOPRFZ', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFSQLF', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFSQIF', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFCQLNG', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFCQNNG', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFSQRF', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFSQSF', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFCQRNG', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFCQSNG', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFSQLTUR', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFSQITUR', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFPLSL', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFPLSN', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFHPSL', KLON, NGPTOTG)
    CALL VALIDATEVAR_ATLAS(FSET, 'PFHPSN', KLON, NGPTOTG)
    ...
    !CALL VALIDATESTATE_ATLAS(FSET, 'TENDENCY_LOC', NGPTOT, NGPTOTG)
